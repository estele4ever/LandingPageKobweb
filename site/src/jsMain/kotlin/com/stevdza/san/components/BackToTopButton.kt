...
import com.stevdza.san.styles.BackToTopBStyle
...
fun BackToTopButton(){
 ...
 var scroll: Double? by remember { mutableStateOf(null) }
    ...
    Column(
        ...
        Box(
            modifier = BackToTopBStyle.toModifier().size(50.px)
                .visibility(if (scroll != null && scroll!! >= 400.0) Visibility.Visible
                else Visibility.Hidden)
                .borderRadius(20.percent)
                .margin(right = if (breakpoint >= Breakpoint.SM) 30.px else 40.px,
