...
@Composable
fun TestimonialCards(breakpoint: Breakpoint,
                     selectedPage :Int) {
...
val testimonial2 = listOf(Testimonial.Second,Testimonial.Fourth,Testimonial.Sixth)
    SimpleGrid(
        modifier = Modifier
            .fillMaxSize(if(breakpoint >= Breakpoint.MD) 90.percent else 100.percent)
            .margin(bottom = 40.px),
        ...
        Box{
            testimonial1.forEach{testimonial->
                TestimonialCard(
                    ...
                    .transition(Transition.of(property = "visibility", duration = 300.ms))
